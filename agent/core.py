...
class UGVISAgent:
    ...
    async def chat(self, user_query: str) -> Dict[str, Any]:
        ...
        if tool_calls:
            ...
            # 基于工具结果生成报告
            report = await self._generate_report(user_query, tool_results)
    ...
    async def _generate_report(self, query: str, data: Dict[str, Any]) -> str:
        """基于数据生成分析报告"""
        # 简化数据，避免超出 token 限制
        ...
        return self.llm.extract_content(response)
